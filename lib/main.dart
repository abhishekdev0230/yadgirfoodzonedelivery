...
Future<void> main() async {
  ...
  // ✅ Firebase init (Web ke liye FirebaseOptions chahiye, Android/iOS ke liye default)
  if (GetPlatform.isAndroid || GetPlatform.isIOS) {
    ...
    await Firebase.initializeApp(
      options: const FirebaseOptions(
        ...
        appId: '1:817746781237:android:aad3fac8e810704efa3d7c',
  ...
  try {
    if (GetPlatform.isMobile) {
      ...
      // 🔹 Foreground messages handle (yahi pe sound + tray show karenge)
